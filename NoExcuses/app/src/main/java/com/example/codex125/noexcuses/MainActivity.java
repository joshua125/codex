...
public class MainActivity extends AppCompatActivity
    ...
    //Muh Buttons
        ...
        private static final String TAG = "LifeCycle Monitor";
        private static final int REQUEST_CODE_CHEAT = 0;
        private static final String KEY_INDEX = "index";
        private boolean mIsCheater;

    //our Array of Question objects to be displayed in our view
    ...
    //we use to determine which index question we display
        ...
        mCheatButton.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
               // start cheat activity
                // mCheatButton.setText("some text");
               // Intent cheatActivityIntent = new Intent(MainActivity.this, CheatActivity.class);
                boolean answerIsTrue = mQuestionList[mCurrentIndex].isAnswerTrue();
                Intent cheatActivityIntent = CheatActivity.newIntent(MainActivity.this, answerIsTrue);
                startActivityForResult(cheatActivityIntent, REQUEST_CODE_CHEAT);
